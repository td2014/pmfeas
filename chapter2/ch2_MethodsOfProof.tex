...
\textit{Solution} We will proceed in a similar approach to the previous exercise.  Suppose $S$ is true.  Then statement (6) is always true regardless of the values of $P$ and $Q$.  Now suppose $S$ is false.
