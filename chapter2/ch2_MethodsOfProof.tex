...
We already have some familiarity with statements that are tautologies.  Let us examine legitimate substitutions.  There are two basic types.  Firstly, consider a statement $A$ that is a tautology which is constructed with another statement $S$.  We are free to replace $S$ by any other statement $S^{*}$ and obtain a new statement $A^{*}$ which is also a tautology.
