...
Note in the above exercises, even though we may have some intuitive sense for the reasons, we must appeal to an exact statement which justifies the assertion.  This may be an axiom, definition, theorem, law etc. which has been established for the objects in question.  This habit will be important to form as we consider other contexts in pure mathematics.
