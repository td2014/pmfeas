...
An important connection exist between recursive relations and the formal system we are considering, namely the system of first order arithmetic.  In particular, a recursive relation is ``expressible" \index{expressible} in this system. 
