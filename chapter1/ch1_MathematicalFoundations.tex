...
The following so-called Zermelo-Frankel Axioms of set theory are presented to help provide the reader a more comprehensive picture of mathematics foundations.  This section is inspired by the set of YouTube lectures by Richard Borcherds \href{https://www.youtube.com/playlist?list=PL8yHsr3EFj52EKVgPi-p50fRP2_SbG2oi}{(ZF Axioms)} and also the book \textit{Axiomatic Set Theory} by Paul Bernays.  The definitions are adapted from Bernays.\\
