...
\textit{Solution}: Yes, according to G\"odel's Completeness Theorem, since the formula is valid (correctly/well-formed).  In fact, in this case it was obtained from Axiom (1) by substituting $X \Longrightarrow Y$ for $X$, immediately verifying the theorem.
